> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [zhuanlan.zhihu.com](https://zhuanlan.zhihu.com/p/113917726)
...
![](https://pic1.zhimg.com/v2-5141ed6f1bddd61750763b51bdc9ecb4_r.jpg)
...
![](https://pic1.zhimg.com/v2-7805f7b4bab4c98adc045e3667046398_r.jpg)
...
![](https://pic3.zhimg.com/v2-4deae667d7d5c9a1a166cb0e8bac9dd6_r.jpg)![](https://pic2.zhimg.com/v2-df9820ea9f7146d09af8280040f185f5_r.jpg)
...
![](https://pic3.zhimg.com/v2-032790aff0ddf52b676413573acce776_r.jpg)
...
![](https://pic1.zhimg.com/v2-1cc416d59d4c44cf029e9e2103347bb8_r.jpg)
...
![](https://pic1.zhimg.com/v2-46e7e44e8ba85e606d68ea9644092d08_r.jpg)
...
![](https://pic1.zhimg.com/v2-60cea4af963b156ee5f40030977ab77c_r.jpg)

现在考虑另一种更为严格的自平衡二叉树 AVL 树。因为 AVL 树是个绝对平衡的二叉树，因此他在调整二叉树的形态上消耗的性能会更多。

AVL 树顺序插入 1~7 个节点，查找 id=7 所要比较节点的次数为 3。

![](https://pic3.zhimg.com/v2-4c39b8eacc6879d661ddb1ed4190aff2_r.jpg)
...
![](https://pic2.zhimg.com/v2-0dad51645707e973b152e44e4b7479c5_r.jpg)
...
![](https://pic2.zhimg.com/v2-f508590121487b595c4ad4fa83d8aa15_r.jpg)

下面是一个存储了 16 个数据的 B 树，同样每个节点最多存储 2 个 key，查询 id=16 这个数据需要查询比较 4 个节点，也就是经过 4 次磁盘 IO。看起来查询性能与 AVL 树一样。

![](https://pic1.zhimg.com/v2-f335bdb3e922a5f334416f557df20848_r.jpg)
...
![](https://pic3.zhimg.com/v2-0fdff8f9a516383548cd0e636f593e52_r.jpg)

一个存储了 16 个数据的 B 树，查询 id=7 这个数据所要进行的磁盘 IO 为 2 次。相对于 AVL 树而言磁盘 IO 次数降低为一半。

![](https://pic1.zhimg.com/v2-7d5e34c698b1e4192ad0ff93c2c897d0_r.jpg)
...
![](https://pic2.zhimg.com/v2-bda6661499c51dcff63eb12fd4b3795d_r.jpg)
...
![](https://pic3.zhimg.com/v2-e4e24288dca3ef02735c41a2a3a69556_r.jpg)![](https://pic3.zhimg.com/v2-0df18cce6c3871fa9e4ac99050bf1692_r.jpg)

执行这两个指令后，系统出现了以下的文件，说明这两个引擎数据和索引的组织方式是不一样的。

![](https://pic2.zhimg.com/v2-8a065d6e21a2adbf06d2e6b5dd02e969_r.jpg)
...
![](https://pic1.zhimg.com/v2-d9a03627e8e1319e46f42e6963c35e30_r.jpg)
...
![](https://pic2.zhimg.com/v2-6e16b355e3d0f05ed8bfb0f7c71de8f1_r.jpg)
...
作者：junshili 更多干货，尽在**[腾讯技术](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/mp/profile_ext%3Faction%3Dhome%26__biz%3DMjM5ODYwMjI2MA%3D%3D%26scene%3D124%23wechat_redirect)**。